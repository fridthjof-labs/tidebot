...
A rate-limit failure returns 503 rather than 500, because GitHub retries 5xx
deliveries and a retry storm is what exhausted the quota in the first place.
